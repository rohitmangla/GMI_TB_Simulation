...
PATH_MODIS = "D:/Datasets/MODIS_L3/monthly/"
...
for ifile in MODIS_FILE:
    ...
    Lat       = sds_lat.get()
    sds_AOD   = file.select ('AOD_550_Dark_Target_Deep_Blue_Combined_Mean_Mean')
    AOD_550   = sds_AOD.get()
   ...
   # m= Basemap(resolution = 'c', projection= 'cyl', llcrnrlon = 73.6753792663, llcrnrlat = 18.197700914, urcrnrlon =135.026311477, urcrnrlat= 53.4588044297)
    ...
    #cs = m.contourf(xx, yy, AOD_550, 15, levels=clevs, cmap=cmap)
...
#    meridians = np.arange(-180., 180., 30.)
    ...
    plt.savefig('D:/Datasets/MODIS_L3/monthly/month_'+str(k)+'.png', dpi= 300)
    k=k+1
